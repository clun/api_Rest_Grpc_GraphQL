...
public class CommentDaoTestIT extends AbstractTest {
    ...
    public List < String > getListComments() {
      ...
      comments.add("Faire de votre projet un succes");
      comments.add("There is no luck");
      comments.add("A girl has no name");
      comments.add("None shall pass");
      comments.add("Yet another comment");
      return comments;
    }
